...
export const ROLES_CONFIG = {
  [UserRole.ADMIN]: {
    ...
    description: 'Acceso completo al sistema, gestiona ingresos de personas y admisiones',
    permissions: [
      'view_all_camps',
      'manage_admissions',
      'view_all_users',
  ...
  [UserRole.TRABAJADOR]: {
    name: 'Trabajador',
    description: 'Realiza cambios de inventario autorizados por gestión de recursos',
    permissions: [
      'view_inventory',
  ...
  [UserRole.GESTOR_RECURSOS]: {
    ...
    description: 'Encargado de traslados y envíos de recursos entre campamentos',
    permissions: [
      'manage_inventory',
      'create_transfers',
      'approve_transfers',
  ...
  [UserRole.SUPERVISOR]: {
    ...
    description: 'Supervisa y audita todas las operaciones del sistema (solo lectura)',
    permissions: [
      'view_all_audit_logs',
      'view_all_transfers',
